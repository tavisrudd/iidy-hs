...
| 5  | oIsTruthy: JavaScript-grade truthiness                  | FIXED                | Zero-is-falsy bug fixed (`ONumber n -> n /= 0`). Three truthiness functions cross-referenced with comments. Truthiness rules formalized in PLT Redex spec (`spec/`). |
