...
User-facing documentation for iidy.

- [Getting Started](getting-started.md) -- installation, first deployment, stack-args.yaml reference
- [YAML Preprocessing](yaml-preprocessing.md) -- tags, imports, Handlebars helpers, debugging
