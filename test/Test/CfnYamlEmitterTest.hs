...
cfnYamlEmitterTests =
    [ testGroup
        ...
        [ testGroup
            ...
            , testCase "float not in scientific notation" $ do
                ...
                assertBool "no 'e' in float output" ('e' `notElem` T.unpack result)
    ...
    , testGroup
        ...
        , testGroup
            "YAML single-quote prefix strings"
        ...
        , testGroup
            "control characters (double-quoted)"
